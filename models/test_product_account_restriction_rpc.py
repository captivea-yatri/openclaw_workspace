...
No odoo-bin / shell required. Run with plain Python 3:
 ...
 python3 models/test_product_account_restriction_rpc.py --url http://localhost:8069 --db odoo --user admin --password ***
...
class ProductAccountRestrictionRPCTest:
 ...
 def run(self) -> bool:
  ...
  # self._cleanup()  # Disabled cleanup as per request
